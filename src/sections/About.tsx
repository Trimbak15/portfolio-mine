    ...
    export const AboutSection = () => {
      ...
      <div className="py-20 lg:py-28">
        ...
        <div className="mt-20 flex flex-col gap-8">
          ...
          <ToolboxItem toolboxItems={toolboxItems} className="mt-6 " toolboxItemsWrapper="animate-move-left [animation-duration:30s]"/>
          <ToolboxItem toolboxItems={toolboxItems} className="mt-6 " toolboxItemsWrapper="-translate-x-1/2 animate-move-right [animation-duration:30s]"/>
          </Card>
          </div>
          ...
          <div className="" ref={constraintRef}>
          ...
          <Card className="h-80 p-0 relative md:col-span-2 mt-8 md:mt-0 md:py-4 lg:col-span-1">
            ...
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-emerald-300 to-sky-400 -z-10 animate-ping-large [animation-duration:3s]"></div>
...
// import React is already handled above with useRef
